...
namespace NHST.Bussiness
{
    public class PJUtils
    {
        ...
        public static bool SendMailGodaddy(string strFrom, string pass, string strTo,
    string strSubject, string strMsg, string cc)
        {
            try
            {
                ...
                MailAddress address = new MailAddress(strFrom);
                msg.From = address;
                ...
                NetworkCredential credentials = new NetworkCredential(strFrom, pass);
        ...
        public static string IntToRequestAdminNew_Thang(int i)
        {
            if (i == 0)
                return "<span class=\"badge red darken-2 white-text border-radius-2\">Lên đơn</span>";
            else if (i == 1)
                ...
                return "<span class=\"badge green darken-2 white-text border-radius-2\">Đặt hàng</span>";
            else if (i == 6)
        ...
        public static string RandomGiaTriString(int numberrandom)
        {
            //var chars = "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789";
            var chars = "123456789";
            var stringChars = new char[numberrandom];
        ...
        public static string RandomCanNangString(int numberrandom)
        {
            //var chars = "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789";
            var chars = "12345";
            var stringChars = new char[numberrandom];
        ...
        public static void PushNotiDesktop(int UID, string title, string link)// đẩy thông báo xuống desktop trình duyệt
        {
            ...
            if (ltoken != null)
            {
                ...
                n.title = "taobaonghean.com";
                n.message = title;
                n.icon = "http://taobaonghean.com/Uploads/NewsIMG/2-10-2020-21420-PM.png";
                n.link = link;
                ...
                foreach (var item in ltoken)
                {
                    try
                    {
                        ...
                        var vapidDetails = new VapidDetails("mailto:NHẬP HÀNG SIÊU TỐCmedia@gmail.com", vapidPublicKey, vapidPrivateKey);
