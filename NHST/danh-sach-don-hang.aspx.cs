            ...
            if (obj_user != null)
            {
                ...
                if (total > 0)
                {
                    ...
                    for (int i = 0; i < acs.Count; i++)
                    {
                        ...
                        //string stt = "";
                        //int moID = Convert.ToInt32(item.ID);
                        //var moCode = MainOrderCodeController.GetAllByMainOrderID(moID);
                        //var otCode = SmallPackageController.GetByMainOrderID(moID);
                        //if (status == 2)
                        //{

                        //    foreach (var itemmo in moCode)
                        //    {
                        //        if (itemmo.MainOrderCode != null)
                        //        {
                        //            stt = "Đã đặt hàng";
                        //        }

                        //    }
                        //    foreach (var itemot in otCode)
                        //    {
                        //        if (itemot.OrderTransactionCode != null)
                        //        {
                        //            stt = "Shop đã phát hàng";
                        //        }
                        ...
                        //        else
                        //        {
                        //            html.Append("<td class=\"no-wrap\">" + stt + "</td>");
                        //        }
                        //    }
                        //    else
                        //    {
                                                    ...
                                                    foreach (var admin in admins)
                                                    {
                                                        try
                                                        {
                                                            PJUtils.SendMailGodaddy("admin@nhaphangsieutoc.com", "Nhaphang@123", admin.Email,
                                                                "Thông báo tại NhapHangTaoBao.", "Đơn hàng " + o.ID + " đã được đặt cọc.", "");
                                                        }
                                                        catch { }
                                                    }
                                                }
                                        ...
                                        if (setNoti.IsSentEmailAdmin == true)
                                        {
                                            ...
                                            if (admins.Count > 0)
                                            {
                                                foreach (var admin in admins)
                                                {
                                                    ...
                                                    {
                                                        PJUtils.SendMailGodaddy("admin@nhaphangsieutoc.com", "Nhaphang@123", admin.Email,
                                                            "Thông báo tại NhapHangTaoBao.", "Đơn hàng " + item.MainOrderID + " đã yêu cầu giao hàng.", "");
                                                    }
                                                    catch { }
                                                }
                                            }
                                    ...
                                    if (setNoti.IsSentEmailAdmin == true)
                                    {
                                        ...
                                        if (admins.Count > 0)
                                        {
                                            foreach (var admin in admins)
                                            {
                                                ...
                                                {
                                                    PJUtils.SendMailGodaddy("admin@nhaphangsieutoc.com", "Nhaphang@123", admin.Email,
                                                        "Thông báo tại NhapHangTaoBao.", "Đơn hàng " + o.ID + " đã được thanh toán.", "");
                                                }
                                                catch { }
                                            }
                                        }
