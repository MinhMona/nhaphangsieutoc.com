...
namespace NHST.Controllers
{
    public class StepController
    {
        ...
        public static string Update(int ID, string StepName, string StepIMG,string Icon, int StepIndex, DateTime ModifiedDate, string ModifiedBy, string StepContent, bool IsHidden)
        {
            using (var dbe = new NHSTEntities())
            {
