...
namespace NHST
{
    public partial class nap_tien_chuyen_khoan_tu_dong : System.Web.UI.Page
    {
        ...
        public static string GetBankInfo(string BankID)
        {
            ...
            {
                string url = "http://tt.NHẬP HÀNG SIÊU TỐC.media/paymentservice.asmx/GetBankInfo?UID=4&Key=NHẬP HÀNG SIÊU TỐCsms-autobanking&BankID=" + BankID + "";
        ...
        public static string CheckPayment(string BankID, string Note)
        {
            ...
            var obj_user = AccountController.GetByUsername(username);
            {
                string url = "http://tt.NHẬP HÀNG SIÊU TỐC.media/paymentservice.asmx/CheckPayment?UID=4&Key=NHẬP HÀNG SIÊU TỐCsms-autobanking&BankID=" + BankID + "&Note=" + Note + "";
                var s = PJUtils.ConnectApi(url);
                if (s != null)
                {
