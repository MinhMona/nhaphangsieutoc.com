...
namespace NHST.serajax
{
    ...
    public class NHTQServices : System.Web.Services.WebService
    {
        ...
        public string receivemonarequesmediat(string title_origin, string title_translated, string price_origin, string price_promotion, string property_translated, string property, string data_value,
