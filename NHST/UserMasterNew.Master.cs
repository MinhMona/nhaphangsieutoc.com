        ...
        public void LoadNotification()
        {
            ...
            if (acc != null)
            {
                ...
                if (config != null)
                {
                    ...
                    ltrHeaderLeft.Text += "<div class=\"balance\"><p>Tiền tích lũy:</p>";
                    ltrHeaderLeft.Text += "<div class=\"balance__number\"><p class=\"vnd\">" + string.Format("{0:N0}", Convert.ToDouble(acc.TienTichLuy)) + " vnđ</p></div>";
