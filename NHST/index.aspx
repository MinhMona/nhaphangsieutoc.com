    ...
    <form id="form1" runat="server">
        <header id="header">
            <div class="all">
                ...
                <div class="logo">
                    <a href="#">
                        <img src="/App_Themes/DemoIndex/images/logo-white.png" alt="Website nhập hàng Trung Quốc by NHẬP HÀNG SIÊU TỐC-Media"></a>
                </div>
                <div class="hd-right">
                ...
                <div class="nav-wrap right" id="main-nav">
                    ...
                    <ul class="nav-ul">
                        <li><a href="https://NHẬP HÀNG SIÊU TỐC-media.com/">Tìm hiểu NHẬP HÀNG SIÊU TỐC Media</a></li>
                                ...
                                <li>
                                    ...
                                    <div class="faq-content">
                                        <p>
                                            Username: demo1<br>
                                            Password: demo1<br>
                                            <a href="http://nhaphangdemo.NHẬP HÀNG SIÊU TỐCmedia.net/dang-nhap" target="_blank">http://nhaphangdemo.NHẬP HÀNG SIÊU TỐCmedia.net/dang-nhap</a>
                                        </p>
                                    </div>
                                    <!-- faq-content -->
                                </li>
        ...
        <footer id="footer">
            <div class="all">
                Designed and developed by NHẬP HÀNG SIÊU TỐC Media
