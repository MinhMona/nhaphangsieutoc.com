            ...
            try
            {
                ...
                if (pt != null)
                {
                    ...
                    if (!string.IsNullOrEmpty(pt.ogimage))
                        ...
                        objMetaFacebook.Content = weblink + "/App_Themes/NHSToc/images/logo.png";
                    ...
                    if (!string.IsNullOrEmpty(pt.metatitle))
                        this.Title = "NHẬP HÀNG SIÊU TỐC - " + pt.metatitle;
                    else
                        this.Title = "NHẬP HÀNG SIÊU TỐC - " + pt.PageTypeName;
        ...
        public void pagingall(List<ListPage> acs)
        {
            ...
            if (acs.Count > 0)
            {
                ...
                for (int i = FromRow; i < ToRow + 1; i++)
                {
                    ...
                    html.Append("<div class=\"column-1\">");
