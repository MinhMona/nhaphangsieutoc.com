...
namespace NHST
{
    public partial class Default1 : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            //PJUtils.SendMailGodaddy("admin@nhaphangsieutoc.com", "Nhaphang@123", "phuong.nguyenthanh90@gmail.com", 
        ...
        public void sendMessage()
        {
            ...
            try
            {
                PJUtils.SendMailGodaddy("admin@nhaphangsieutoc.com", "Nhaphang@123", 
                    "phuong.nguyenthanh90@gmail.com", "Reset Mật khẩu trên NHẬP HÀNG SIÊU TỐC",
                    "Mật khẩu mới của bạn trên hệ thống NHẬP HÀNG SIÊU TỐC: <strong>hehe</strong>", "");
            }
            catch { }
        }
        [WebMethod]
