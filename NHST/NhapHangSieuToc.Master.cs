...
namespace NHST
{
    public partial class NhapHangSieuToc : System.Web.UI.MasterPage
    {
        ...
        public void LoadMenu()
        {
            ...
            if (categories != null)
            {
                html += "<div class=\"hamburger-btn main-menu-btn\">";
                ...
                html += "</ul>";
                html += "<div class=\"main-menu-overlay\">";
                html +="</div>";
                ltrMenu.Text = html;
            }
        }
        ...
        public void LoadData()
        {
            ...
            if (confi != null)
            {
                ...
                ltrTop.Text += "<a>Tỉ giá: 1¥ = <span>" + string.Format("{0:N0}", Convert.ToDouble(confi.Currency)) + "</span></a>";
                //ltrTop.Text += "<li>" + timework + "</li>";
                //< p >< a href = "#" > myinfo@NHẬP HÀNG SIÊU TỐC - media.com </ a ></ p >
                ltrTopPhone.Text += "<p><a href=\"tel:" + hotline + "\">" + hotline + "</a></p>";

                ltrTop.Text += "<a>Email: <span><a href=\"mailto:" + email + "\">" + email + "</a></span></a>";
            ...
            if (Session["userLoginSystem"] != null)
            {
                ...
                if (acc != null)
                {
                    ...
                    ltrLogin.Text += "<a class=\"acc-info-btn\" href=\"/thong-tin-nguoi-dung\"><i class=\"icon fa fa-user\" style=\"margin-right: 5px;\"></i><span>" + username + "</span></a>";
                    ...
                    ltrLogin.Text += "<p>Tiền tích lũy:</p>";
                    ltrLogin.Text += "<div class=\"balance__number\"><p class=\"vnd\">" + string.Format("{0:N0}", Convert.ToDouble(acc.TienTichLuy)) + " vnđ</p></div>";
                    ltrLogin.Text += "</div>";
            ...
            {
                ltrLogin.Text = "<div class=\"account-nav\"><a href=\"/dang-nhap\">Đăng nhập</a> | <a href=\"/dang-ky\">Đăng ký</a></div>";
            }
        }
    }
}