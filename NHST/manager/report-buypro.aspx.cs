    ...
    public partial class report_buypro : System.Web.UI.Page
    {
        ...
        public void LoadData()
        {
            ...
            if (la.Count > 0)
            {
                ...
                double[] data2 = new double[] { TotalPrice, TotalRealPrice, TotalInterest };
                ...
                string dataChartTotal = new JavaScriptSerializer().Serialize(
                                               new
                                               {
                                                   labels = "[\"Tổng tiền đơn hàng\", \"Tổng tiền thật\", \"Tổng tiền lời\"]",
        ...
        protected void btnExport_Click(object sender, EventArgs e)
        {
            ...
            if (ListOrder.Count > 0)
            {
                foreach (var o in ListOrder)
                {
                    ...
                    or.SalerID = Convert.ToInt32(o.SalerID);
                    or.DathangID = Convert.ToInt32(o.DathangID);
            ...
            {
                var a = AccountController.GetBySalerID(item.SalerID);
                var b = AccountController.GetByDathangID(item.DathangID);
                StrExport.Append("  <tr>");
                ...
                if (item.DathangID !=0)
                {
                    StrExport.Append("      <td>" + b.Username + "</td>");
                ...
                if (item.SalerID != 0)
                {
                    StrExport.Append("      <td>" + a.Username + "</td>");
