...
namespace NHST.manager
{
    public partial class OrderDetail : System.Web.UI.Page
    {
                ...
                if (o != null)
                {
                    ...
                    if (obj_user != null)
                    {
                        ...
                        if (!string.IsNullOrEmpty(o.AmountDeposit))
                        {
                            ...
                            pAmountDeposit.Text = amountdeposit.ToString();
                        ...
                        if (!string.IsNullOrEmpty(o.TotalPriceReal))
                            rTotalPriceReal.Text = Math.Round(Convert.ToDouble(o.TotalPriceReal), 0).ToString();
                        else
                        ...
                        if (!string.IsNullOrEmpty(o.Deposit))
                            pDeposit.Text = Math.Round(Convert.ToDouble(o.Deposit), 0).ToString();
        ...
        protected void btnSend_Click(object sender, EventArgs e)
        {
            ...
            //                    try
            //                    {
            //                        PJUtils.SendMailGodaddy("admin@nhaphangsieutoc.com", "Nhaphang@123",
            //                            AccountInfoController.GetByUserID(Convert.ToInt32(o.UID)).Email,
            //                            "Thông báo tại NhapHangTaoBao.",
            //                            "Đã có đánh giá mới cho đơn hàng #" + id
            //                            + " của bạn. CLick vào để xem", "");
                    ...
                    if (o != null)
                    {
                        ...
                        else
                        {
                            ...
                            if (OCurrent_deposit != Deposit)
                            {
                                ...
                                //try
                                //{
                                //    PJUtils.SendMailGodaddy("admin@nhaphangsieutoc.com", "Nhaphang@123", AccountInfoController.GetByUserID(Convert.ToInt32(o.UID)).Email,
                        ...
                        if (currentstt < 3 || currentstt > 7)
                        {
                            if (status != currentstt)
                            {
                                ...
                                try
                                {
                                    //PJUtils.SendMailGodaddy("cskh@1688pgs.vn", "1688pegasus", 
                                    //AccountInfoController.GetByUserID(Convert.ToInt32(o.UID)).Email, 
                        ...
                        else if (currentstt > 2 && currentstt < 8)
                        {
                            if (status < 3 || status > 7)
                            {
                                ...
                                try
                                {
                                    //PJUtils.SendMailGodaddy("cskh@1688pgs.vn", "1688pegasus", AccountInfoController.GetByUserID(Convert.ToInt32(o.UID)).Email, 
                            ...
                            if (setNoti != null)
                            {
                                ...
                                if (setNoti.IsSendEmailUser == true)
                                {
                                    try
                                    {
                                        PJUtils.SendMailGodaddy("admin@nhaphangsieutoc.com", "Nhaphang@123",
                                            accmuahan.Email,
                                            "Thông báo tại NhapHangTaoBao.", "Đơn hàng " + o.ID
                                            + " đã được mua hàng.", "");
                                    }
                                    catch { }
                                }
