                                        ...
                                        <div class="order-row">
                                            ...
                                            <div class="right-content">
                                                <div class="row">
                                                    ...
                                                    <div class="input-field col s12 m5">
                                                        <asp:TextBox runat="server" ID="pPackedNDT" placeholder="0" type="number" onkeyup="CountFeePackage('ndt')" value=""></asp:TextBox>
                                                        <label>Tệ (¥)</label>
                                                    </div>
                                                    <div class="input-field col s12 m5">
                                                        <asp:TextBox runat="server" ID="pPacked" placeholder="0" type="number" onkeyup="CountFeePackage('vnd')" value=""></asp:TextBox>
                                                        <label>Việt Nam Đồng (VNĐ)</label>
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="right-content">
                                                <div class="row">
                                                    ...
                                                    <div class="input-field col s12 m10">
                                                        <asp:TextBox runat="server" ID="txtInsuranceMoney" placeholder="0" type="number" Enabled="false" value=""></asp:TextBox>
                                                        <label>Việt Nam Đồng (VNĐ)</label>
                                                    </div>
                                                </div>
                                            </div>
                                        ...
                                        <div class="order-row" style="display: none">
                                            ...
                                            <div class="right-content">
                                                <div class="row">
                                                    ...
                                                    <div class="input-field col s12 m5">
                                                        <asp:TextBox runat="server" ID="pShipHome" placeholder="0" type="number" value=""></asp:TextBox>
                                                        <label>Việt Nam Đồng (VNĐ)</label>
                                                    </div>
                                                </div>
                                            </div>
                                    ...
                                    <div class="content-panel">
                                        <div class="order-row">
                                            ...
                                            <div class="right-content">
                                                <div class="row">
                                                    <div class="input-field col s12">
                                                        <asp:TextBox runat="server" ID="pAmountDeposit" placeholder="0" type="number"></asp:TextBox>
                                                        <label>Việt Nam Đồng (VNĐ)</label>
                                                    </div>
                                                </div>
                                            </div>
                                        ...
                                        <div class="order-row">
                                            ...
                                            <div class="right-content">
                                                <div class="row">
                                                    <div class="input-field col s12">
                                                        <asp:TextBox runat="server" ID="pDeposit" placeholder="0" type="number"></asp:TextBox>
                                                        <label>Việt Nam Đồng (VNĐ)</label>
                                                    </div>
                                                </div>
                                            </div>
