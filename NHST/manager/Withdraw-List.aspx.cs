            ...
            if (w != null)
            {
                if (w.Status < 3)
                {
                    ...
                    if (status == 2)
                    {
                        ...
                        if (acc.RoleID == 0 || acc.RoleID == 2 || acc.RoleID == 7)
                        {
                            ...
                            if (user_rut != null)
                            {
                                ...
                                if (setNoti != null)
                                {
                                    ...
                                    if (setNoti.IsSendEmailUser == true)
                                    {
                                        try
                                        {
                                            PJUtils.SendMailGodaddy("admin@nhaphangsieutoc.com", "Nhaphang@123", user_rut.Email,
                                                "Thông báo tại NHẬP HÀNG SIÊU TỐC.", "Admin đã duyệt lệnh rút tiền của bạn.", "");
                                        }
                                        catch { }
                                    }
                                }
                        ...
                        if (user_rut != null)
                        {
                            ...
                            if (setNoti != null)
                            {
                                ...
                                if (setNoti.IsSendEmailUser == true)
                                {
                                    try
                                    {
                                        PJUtils.SendMailGodaddy("admin@nhaphangsieutoc.com", "Nhaphang@123", user_rut.Email, "Thông báo tại NHẬP HÀNG SIÊU TỐC.", "Admin đã hủy lệnh rút tiền của bạn.", "");
                                    }
                                    catch { }
                                }
                            }
