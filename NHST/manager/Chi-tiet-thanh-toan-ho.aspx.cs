                                        ...
                                        if (walletCYN >= TotalPrice)
                                        {
                                           ...
                                           8, currentDate, ac.Username, true);
                                                        ...
                                                        if (setNoti.IsSendEmailUser == true)
                                                        {
                                                            try
                                                            {
                                                                PJUtils.SendMailGodaddy("admin@nhaphangsieutoc.com", "Nhaphang@123", usend.Email,
                                                                    "Thông báo tại NHẬP HÀNG SIÊU TỐC.",
                                                                    "Đơn thanh toán hộ: " + ID + "  của bạn đã được hoàn thành.",
                                                                    "");
                                                            }
                                                            catch { }
                                                ...
                                                //    try
                                                //    {
                                                //        //PJUtils.SendMailGodaddy("nhaphangsieutoc1688@gmail.com", "oiecjnsgwpsfgndz", usend.Email, "Thông báo đã hoàn thành thanh toán hộ tại nhaphangsieutoc.com", "Yêu cầu thanh toán hộ của bạn đã hoàn thành tại nhaphangsieutoc.com.", "");
                                                //        PJUtils.SendMailDomain("lienhe@nhaphangsieutoc.top", "0Chitaobiet", usend.Email, "Thông báo đã hoàn thành thanh toán hộ tại nhaphangsieutoc.com", "Yêu cầu thanh toán hộ của bạn đã hoàn thành tại nhaphangsieutoc.com.", "");
                                                //    }
                                                //    catch { }
                                                //}
                    ...
                    else if (status_old == 1)
                    {
                        if (status == 0 || status == 2)
                        {
                           ...
                           8, currentDate, ac.Username, true);
                            ...
                            //    {
                            //        //PJUtils.SendMailGodaddy("nhaphangsieutoc1688@gmail.com", "oiecjnsgwpsfgndz", usend.Email, "Thông báo đã hoàn thành thanh toán hộ tại nhaphangsieutoc.com", "Yêu cầu thanh toán hộ của bạn đã hoàn thành tại nhaphangsieutoc.com.", "");
                            //        PJUtils.SendMailDomain("lienhe@nhaphangsieutoc.top", "0Chitaobiet", usend.Email, "Thông báo đã hủy thanh toán hộ tại nhaphangsieutoc.com", "Yêu cầu thanh toán hộ của bạn đã bị hủy tại nhaphangsieutoc.com.", "");
                            //    }
                            //    catch { }
                            //}
                            PJUtils.ShowMessageBoxSwAlert("Cập nhật thành công", "s", true, Page);
                    ...
                    else
                    {
                       ...
                       8, currentDate, ac.Username, true);
                                    ...
                                    if (setNoti.IsSendEmailUser == true)
                                    {
                                        ...
                                        {
                                            PJUtils.SendMailGodaddy("admin@nhaphangsieutoc.com", "Nhaphang@123", usend.Email,
                                                "Thông báo tại NHẬP HÀNG SIÊU TỐC.", "Đơn thanh toán hộ: " + ID + "  của bạn đã hoàn thành.", "");
                                        }
                                        catch { }
                                    }
                                }
