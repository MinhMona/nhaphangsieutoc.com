...
namespace NHST.manager
{
    public partial class UserList1 : System.Web.UI.Page
    {
        ...
        public void LoadPrefix()
        {
            ...
            var saler = AccountController.GetAllWithStaff(3);
            if (saler.Count > 0)
            {
                ddlSale.DataSource = saler;
                ddlSale.DataBind();
            }
            var dealer = AccountController.GetAllWithStaff(6);
            if (dealer.Count > 0)
            {
                ddlDathang.DataSource = dealer;
                ddlDathang.DataBind();
            }
        }
        ...
        protected void btnExcel_Click(object sender, EventArgs e)
        {
            ...
            var la = AccountController.GetAll_ViewUserListExcel("").ToList();
