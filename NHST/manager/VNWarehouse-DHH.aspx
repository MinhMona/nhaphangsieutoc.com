        ...
        function printBarcode(barcode) {
            ...
            $.ajax({
                ...
                success: function (msg) {
                    ...
                    html += "           <label class=\"row-name\" style=\"width:50%\">ID đơn hàng: </label>";
                    html += "           <label class=\"row-info\">" + data.MainOrderID + "</label>";
                    html += "       </div>";
                    html += "       <div class=\"bill-row\" style=\"display:inline-flex;border-bottom: solid 1px #000;\">";
                    ...
                    html += "       </div>";
                    html += "       <div class=\"bill-row\" style=\"display:inline-flex;border-bottom: solid 1px #000;\">";
                    html += "           <label class=\"row-name\" style=\"width:50%\">Mã đơn hàng: </label>";
                    html += "           <label class=\"row-info\">" + data.MainOrderCode + "</label>";
                    html += "       </div>";
                    html += "       <div class=\"bill-row\" style=\"display:inline-flex;border-bottom: solid 1px #000;\">";
