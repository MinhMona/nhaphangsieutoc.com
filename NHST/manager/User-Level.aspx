                        ...
                        <table class="table bordered centered highlight  ">
                            <thead>
                                <tr>
                                    ...
                                    <th class="tb-date">Chiết khấu phí mua hàng (%)</th>
                                    <th class="tb-date">Chiết khấu cân nặng (%)</th>
                                    <th>Đặt cọc (%)</th>
                                    <th>Thao tác</th>
                                </tr>
                            </thead>
        ...
        <div class="modal-bd">
            <div class="row">
                ...
                <div class="input-field col s12">
                    ...
                    <label for="edit_type">Chiết khấu cân nặng (%)</label>
                </div>
                <div class="input-field col s12">
                ...
                <div class="input-field col s12">
                    ...
                    <label for="edit_fee">Đặt cọc (%)</label>
                </div>
            </div>
        </div>
        <div class="modal-ft">
