    ...
    public partial class Home_Config : System.Web.UI.Page
    {
        ...
        public void LoadStep()
        {
            ...
            for (int i = 0; i < listStep.Count; i++)
            {
                ...
                hcm.Append("<td>" + PJUtils.ShowIMG40x40(item.Icon) + "</td>");
        ...
        protected void BtnUpStep_Click(object sender, EventArgs e)
        {
            ...
            if (EditStepIcon.HasFiles)
            {
                foreach (HttpPostedFile f in EditStepIcon.PostedFiles)
                {
                    string fileContentType = f.ContentType; // getting ContentType
                ...
                ICON = EditIconBefore.ImageUrl;

            string kq = StepController.Update(StepID, EditStepName.Text, IMG, ICON, Convert.ToInt32(EditStepIndex.Text), DateTime.Now, Username, EditStepSumary.Text, IsHidden);
        ...
        protected void btnUpBenefit_Click(object sender, EventArgs e)
        {
            ...
            var kq = CustomerBenefitsController.Update(CBID, IMG, CustomerBenefitName,
                CustomerBenefitDescription, CustomerBenefitLink, IsHidden, Position, Email);
