                                ...
                                if (mainorder != null)
                                {
                                    ...
                                    if (smallpackages.Count > 0)
                                    {
                                        ...
                                        if (isChuaVekhoTQ == false)
                                        {
                                            ...
                                            //                     try
                                            //                     {
                                            //                         PJUtils.SendMailGodaddy("admin@nhaphangsieutoc.com", "Nhaphang@123", acc.Email,
                                            //                             "Thông báo tại NHẬP HÀNG SIÊU TỐC.", "Hàng của đơn hàng " + MainorderID + " đã về kho TQ.", "");
                                            //                     }
                                            //                     catch { }
                                            //                 }
                                            //             }
                                                ...
                                                if (setNoti != null)
                                                {
                                                    ...
                                                    if (acc != null)
                                                    {
                                                        ...
                                                        if (setNoti.IsSendEmailUser == true)
                                                        {
                                                            ...
                                                            {
                                                                PJUtils.SendMailGodaddy("admin@nhaphangsieutoc.com", "Nhaphang@123", acc.Email,
                                                                    "Thông báo tại NHẬP HÀNG SIÊU TỐC.", "Đơn hàng vận chuyển hộ " + tID + " đã về kho TQ.", "");
                                                            }
                                                            catch { }
                                                        }
                                                    }
                ...
                if (user != null)
                {
                    ...
                    if (userRole == 0 || userRole == 2 || userRole == 4)
                    {
                        if (!string.IsNullOrEmpty(barcode))
                        {
                                ...
                                if (Convert.ToInt32(sm.MainOrderID) > 0)
                                {
                                    ...
                                    if (main != null)
                                    {
                                        ...
                                        if (ac != null)
                                        {
                                            ...
                                            Phone = "0984" + PJUtils.RandomString(6);
                                            GiaTri = PJUtils.RandomGiaTriString(6);
                                            CanNang = PJUtils.RandomCanNangString(1);
                                        }
                                    }
                                }
                            ...
                            b.Phone = Phone;
                            b.Address = Address;
                            b.GiaTri = string.Format("{0:N0}", Convert.ToDouble(GiaTri));
                            b.CanNang = CanNang;
