                                    ...
                                    for (var i = 0; i < data.length; i++) {
                                        ...
                                        if (item.length > 0) {
                                            for (var j = 0; j < item.length; j++) {
                                                ...
                                                html += "<span class=\"image\"><img src=\"" + temp.Image + "\" class=\"\" alt=\"image\" data-caption=\"Số lượng: " + temp.SoLuong + "\"></span>";
        ...
        function printBarcode(barcode) {
            ...
            $.ajax({
                ...
                success: function (msg) {
                    ...
                    html += " <div class=\"table-main\">";
                    html += "   <table border=\"1\" style=\"border-collapse: collapse;\">";
                    html += "       <tr>";
                    html += "           <th style=\"width:50%;padding:5px;border-right:1px solid rgba(0,0,0,0.5);text-align:center;\">From(Shipper)</th>";
                    html += "           <th style=\"width:50%;padding:5px;border-right:1px solid rgba(0,0,0,0.5);border-top:1px solid rgba(0,0,0,0.5);border-bottom:1px solid rgba(0,0,0,0.5);\"><img style=\"width:20%;display:block;margin: 0 auto;padding: 10px 0;\" src=\"/App_Themes/NHSToc/images/logo-export.png\" alt=\"\"></th>";
                    html += "       </tr>";
                    html += "       <tr>";
                    html += "           <td style=\"width:400px;padding:5px; text-align:center;border-right:1px solid rgba(0,0,0,0.5);\">Thuan Phat LTD - 18775915560 </br>No 389 Nan Da Road, Ping Xiang City,</br> Guangxi Province, China</td>";
                    html += "           <td class=\"text-bold td-1\" style=\"font-weight: bold;text-align:center;width:400px;padding:5px;border-right:1px solid rgba(0,0,0,0.5);border-left:1px solid rgba(0,0,0,0.5);border-bottom:1px solid rgba(0,0,0,0.5);\">Tracking Number</td>";
                    html += "       </tr>";
                    html += "       <tr>";
                    html += "           <td style=\"border:1px solid gray;padding:5px;border-right:1px solid rgba(0,0,0,0.5);\"></td>";
                    html += "           <td class=\"number-bold td-2\" style=\"font-size: 60px;text-align:center;border-right:1px solid rgba(0,0,0,0.5);border-left:1px solid rgba(0,0,0,0.5);border-bottom:1px solid rgba(0,0,0,0.5);\"><label><span style=\"display: block; font-size:36px; letter-spacing:3px;padding:5px;\"> " + data.Barcode + " </span></label></td>";
                    html += "       </tr>";
                    html += "       <tr>";
                    html += "           <td class=\"text-1\" style=\"font-weight: bold;border-bottom:1px solid #fff;padding:5px;border-right:1px solid rgba(0,0,0,0.5);\">To (Consignee)</td>";
                    html += "           <td class=\"text-1\" style=\"font-weight: bold;border-bottom:1px solid #fff;padding:5px;\">DESC:</td>";
                    html += "       </tr>";
                    html += "       <tr>";
                    html += "           <td style=\"padding:5px;border-right:1px solid rgba(0,0,0,0.5);\">";
                    html += "               <label class=\"row-name\" style=\"width:50%\">Username: </label>";
                    html += "               <label class=\"row-info\">" + data.Username + "</label>";
                    html += "                   </br>";
                    html += "               <label class=\"row-name\" style=\"width:50%\">Address: </label>";
                    html += "               <label class=\"row-info\">" + data.Address + "</label>";
                    html += "                   </br>";
                    html += "               <label class=\"row-name\" style=\"width:50%\">Phone: </label>";
                    ...
                    html += "           <td colspan=\"2\" style=\"padding:5px;border-right:1px solid rgba(0,0,0,0.5);\">Carriage value:</td>";
                    html += "       </tr>";
                    html += "       <tr style=\"padding:5px;\">";
                    html += "           <td colspan=\"2\" style=\"padding:5px;border-right:1px solid rgba(0,0,0,0.5);\">Extra charge:</td>";
                    html += "       </tr>";
                    html += "       <tr>";
                    html += "           <td colspan=\"2\" style=\"padding:5px;border-right:1px solid rgba(0,0,0,0.5);\">Service type:</td>";
                    html += "       </tr>";
                    html += "       <tr style=\"padding:5px;\">";
                    html += "           <td colspan=\"2\" style=\"padding:5px;border-right:1px solid rgba(0,0,0,0.5);\"><input type=\"checkbox\" id=\"scales\" name=\"scales\">";
                    html += "               <label for=\"scales\">Door to door (free tax include)</label></td>";
                    html += "       </tr>";
                    html += "       <tr>";
                    html += "           <td colspan=\"2\" style=\"padding:5px;border-right:1px solid rgba(0,0,0,0.5);\"><input type=\"checkbox\" id=\"horne\" name=\"horne\">";
                    html += "               <label for=\"hornes\">To airport / other customer pay fee tax</label></td>";
                    html += "       </tr>";
                    html += "       <tr>";
                    html += "           <td colspan=\"2\" style=\"padding:5px;border-right:1px solid rgba(0,0,0,0.5);\">ActWgt: " + data.CanNang + " | Ship Date : 19-Jun-2020</td>";
                    html += "       </tr>";
                    html += "       <tr>";
                    html += "           <td colspan=\"2\" style=\"padding:5px;border-right:1px solid rgba(0,0,0,0.5);\">Number of package : 1</td>";
                    html += "       </tr>";
                    html += "       <tr>";
                    html += "           <td colspan=\"2\" class=\"td-9\" style=\"padding:5px;border-bottom:1px solid rgba(0,0,0,0.5);border-right:1px solid rgba(0,0,0,0.5);\">Value: "  + data.GiaTri + " (VNĐ)</td>";
                    html += "       </tr>";
                    html += "       <tr>";
                    html += "           <td colspan=\"2\" class=\"td-10\" style=\"padding:5px;border-bottom:1px solid rgba(0,0,0,0.5);border-right:1px solid rgba(0,0,0,0.5);\">The Montreal or Warsaw Convention may apply and will govern and in most cases limit the liability of SCE for loss or delay of or damage to your shipment. Subject to the conditions of the contract on the reverse.</td>";
                    html += "       </tr>";
                    html += "  </table>";
                    html += " </div>";
                ...
                success: function (msg) {
                    if (msg.d != null) {
                        ...
                        for (var i = 0; i < temp.length; i++) {
                            ...
                            html += "<div class=\"pa-product-item\">";
                            html += "<div class=\"block-img\" style>";
                            html += "<span class=\"image\"><img src=\"" + item.Image + "\" class=\"\" alt=\"image\" data-caption=\"Số lượng: " + item.SoLuong + "\"></span>";
                            html += "<label><input name=\"group1\" type=\"radio\"/><span></span></label>";
