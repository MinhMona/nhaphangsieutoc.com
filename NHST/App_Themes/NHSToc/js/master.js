...
//                    top cont && bottom cont
    ...
    function initmap() {
        var myLatlng = new google.maps.LatLng(10.785729199999999,106.66640849999999);
        var mapOptions = {
...
//              position: google.maps.ControlPosition.BOTTOM_LEFT
    ...
    map = new google.maps.Map(mapElement, mapOptions);
        createMarker(myLatlng,'<a href="https://NHẬP HÀNG SIÊU TỐC-media.com/dich-vu/thiet-ke-website-chuyen-nghiep/" title="Công ty thiế kế website chuyên nghiệp">Thiết kế website</a>&nbsp;<img src="http://NHẬP HÀNG SIÊU TỐC-media.com/logo.png" style="width:20px;vertical-align:sub" alt="NHẬP HÀNG SIÊU TỐCMedia"> <strong>NHẬP HÀNG SIÊU TỐC Media</strong>').setMap(map);
    }
