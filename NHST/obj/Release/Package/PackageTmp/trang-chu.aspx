                        ...
                        <div class="slider-cont slider-quote" id="slider-quote">
                            <div class="slider-item">
                                <div class="quote-box">
                                    ...
                                    <div class="info">
                                        <div class="title"><strong>NHẬP HÀNG SIÊU TỐC MEDIA</strong>/<span class="hl-txt">Designer</span></div>
                                        <div class="spec">
                                            <blockquote>
                                                <p>
                ...
                <div class="main">
                    ...
                    <ul class="activity-ul">
                        <li class="hvr-icon-push">
                            <a class="img" href="mailto:myinfo@NHẬP HÀNG SIÊU TỐC-media.com"><i class=" fa fa-envelope"></i></a>
                            <a class="info" href="mailto:myinfo@NHẬP HÀNG SIÊU TỐC-media.com">
                                <div class="title"><strong>Email Contact</strong></div>
                                <p>myinfo@NHẬP HÀNG SIÊU TỐC-media.com</p>
                            </a>
                        </li>
                        <li class="hvr-icon-push">
