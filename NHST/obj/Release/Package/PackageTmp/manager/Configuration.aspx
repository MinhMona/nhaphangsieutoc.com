        ...
        <div class="row">
            ...
            <div class="page-title">
                <div class="card-panel">
                    <h4 class="title no-margin" style="display: inline-block;">CẤU HÌNH HỆ THỐNG NHẬP HÀNG SIÊU TỐC</h4>
                    ...
                    <div class="col s12 m12 l4 sticky-wrap">
                        <div class="hide-on-small-only card-panel">
                            <ul class="table-of-contents ">
                                ...
                                <li><a href="#footer-sec" style="display:none">Cấu hình Footer</a></li>
