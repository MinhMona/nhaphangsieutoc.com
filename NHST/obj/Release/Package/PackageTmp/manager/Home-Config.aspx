        ...
        <div class="modal-bd">
            <div class="row">
                ...
                <div class="input-field col s12 m6">
                    ...
                    <label class="active" for="edit__step-number">Vị trí</label>
                </div>
                <div class="input-field col s12">
                    <span class="black-text">Icon</span>
                    <div style="display: inline-block; margin-left: 15px;">
                        <asp:FileUpload runat="server" ID="EditStepIcon" class="upload-img" type="file" onchange="previewFiles(this);" title=""></asp:FileUpload>
                        <button class="btn-upload">Upload</button>
                    </div>
                    <div class="preview-img">
                        <asp:Image ID="EditIconBefore" runat="server" />
                    </div>
                </div>
                <div class="input-field col s12">
            ...
            $.ajax({
                ...
                success: function (msg) {
                    ...
                    if (data != null) {
                        ...
                        $('#<%=EditIconBefore.ClientID%>').attr("src", data.Icon);
