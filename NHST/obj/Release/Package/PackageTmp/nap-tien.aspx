                                                ...
                                                <div class="col s12">
                                                    ...
                                                    <div class="donate-guide">
                                                        ...
                                                        <strong>thanh toán</strong> một khoản tiền <strong>đặt
                                                            cọc trước cho NHẬP HÀNG SIÊU TỐC </strong> để chúng tôi thực hiện
                                                        ...
                                                        website đặt hàng Trung Quốc, số tiền này <strong> NHẬP HÀNG SIÊU TỐC thu hộ cho </strong>
                                                        nhà cung cấp.
                                                        </p>
                                                        <p class="pl-3">
                                                            + <strong>Phí dịch vụ</strong>: là phí khách hàng
                                                        trả cho <strong> NHẬP HÀNG SIÊU TỐC </strong> để tiến hành thu mua theo đơn hàng đã đặt.
                                                        </p>
                                                        ...
                                                        <p class="pl-3">
                                                            + <strong>59 Hoàng Cầu, Đống Đa, Hà Nội</strong>
                                                        </p>
                                                    ...
                                                    <div class="card-panel donate-information mt-3">
                                                        ...
                                                        <%-- <div class="order-row">
                                                            <div class="left-fixed">
                                                                <span>Ảnh đối chiếu:</span>
                                                            </div>
                                                            <div class="right-content">
                                                                <div class="row">
                                                                    <div class=" col s12 display-flex">
                                                                        <div>
                                                                            <input class="upload-img" type="file" multiple
