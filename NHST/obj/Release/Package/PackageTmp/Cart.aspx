                                ...
                                <div class="col s12 order-info">
                                    ...
                                    <div class="order-notice">
                                        <div class="notice-wrap grey lighten-4">
                                            <p style="color:red">Sản phẩm trong giỏ sẽ tự động xóa trong vòng 15 ngày.</p>
                                            <p>Người bán trên website 1688.com thường có quy định về số lượng mua tối thiểu, bội số mỗi sản phẩm, giá trị đơn hàng tối thiểu và sẽ từ chối bán nếu không đáp ứng. Trong trường hợp đó
                                                <asp:Literal runat="server" ID="ltrTitle"></asp:Literal>
                                                sẽ hủy những đơn hàng này và không báo trước.</p>
                                        </div>
                                    </div>
                                </div>
                                <div class="col s12">
